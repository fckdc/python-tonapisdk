...
import fdtapi
from fdtapi.models.auction_bid_action import AuctionBidAction  # noqa: E501
from fdtapi.rest import ApiException

class TestAuctionBidAction(unittest.TestCase):
    """AuctionBidAction unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AuctionBidAction
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuctionBidAction`
        """
        model = fdtapi.models.auction_bid_action.AuctionBidAction()  # noqa: E501
        if include_optional :
            return AuctionBidAction(
                ...
                bidder = fdtapi.models.account_address.AccountAddress(
                    ...
                    is_scam = True, 
                    icon = 'https://ton.org/logo.png', ), 
                auction = fdtapi.models.account_address.AccountAddress(
                    address = '0:10C1073837B93FDAAD594284CE8B8EFF7B9CF25427440EB2FC682762E1471365', 
                    name = 'Ton foundation', 
                    is_scam = True, 
                    icon = 'https://ton.org/logo.png', )
