...
class GetRawBlockchainBlock200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetRawBlockchainBlock200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetRawBlockchainBlock200Response:
        """Create an instance of GetRawBlockchainBlock200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetRawBlockchainBlock200Response.parse_obj(obj)

        _obj = GetRawBlockchainBlock200Response.parse_obj({
