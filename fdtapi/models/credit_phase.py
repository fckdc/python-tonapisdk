...
class CreditPhase(BaseModel):
    ...
    credit: StrictInt = Field(...)
    __properties = ["fees_collected", "credit"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreditPhase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreditPhase:
        """Create an instance of CreditPhase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreditPhase.parse_obj(obj)

        _obj = CreditPhase.parse_obj({
