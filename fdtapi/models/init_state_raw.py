...
class InitStateRaw(BaseModel):
    ...
    __properties = ["workchain", "root_hash", "file_hash"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InitStateRaw:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InitStateRaw:
        """Create an instance of InitStateRaw from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InitStateRaw.parse_obj(obj)

        _obj = InitStateRaw.parse_obj({
