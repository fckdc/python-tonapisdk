...
class JettonPreview(BaseModel):
    ...
    __properties = ["address", "name", "symbol", "decimals", "image", "verification"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JettonPreview:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JettonPreview:
        """Create an instance of JettonPreview from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JettonPreview.parse_obj(obj)

        _obj = JettonPreview.parse_obj({
