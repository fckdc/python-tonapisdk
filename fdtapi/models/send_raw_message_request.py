...
class SendRawMessageRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SendRawMessageRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SendRawMessageRequest:
        """Create an instance of SendRawMessageRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SendRawMessageRequest.parse_obj(obj)

        _obj = SendRawMessageRequest.parse_obj({
            "body": obj.get("body")
        })
        return _obj
