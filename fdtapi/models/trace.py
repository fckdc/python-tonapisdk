...
class Trace(BaseModel):
    ...
    children: Optional[conlist(Trace)] = None
    __properties = ["transaction", "interfaces", "children"]
    ...
    def from_dict(cls, obj: dict) -> Trace:
        ...
        _obj = Trace.parse_obj({
            ...
            "children": [Trace.from_dict(_item) for _item in obj.get("children")] if obj.get("children") is not None else None
        })
        return _obj
