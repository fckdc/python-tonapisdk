...
class JettonsBalances(BaseModel):
    ...
    JettonsBalances
    """
    balances: conlist(JettonBalance) = Field(...)
    __properties = ["balances"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JettonsBalances:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JettonsBalances:
        """Create an instance of JettonsBalances from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JettonsBalances.parse_obj(obj)

        _obj = JettonsBalances.parse_obj({
            "balances": [JettonBalance.from_dict(_item) for _item in obj.get("balances")] if obj.get("balances") is not None else None
        })
        return _obj
