...
class TonTransferAction(BaseModel):
    ...
    TonTransferAction
    """
    sender: AccountAddress = Field(...)
    recipient: AccountAddress = Field(...)
    amount: StrictInt = Field(..., description="amount in nanotons")
    comment: Optional[StrictStr] = None
    encrypted_comment: Optional[EncryptedComment] = None
    refund: Optional[Refund] = None
    __properties = ["sender", "recipient", "amount", "comment", "encrypted_comment", "refund"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TonTransferAction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TonTransferAction:
        """Create an instance of TonTransferAction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TonTransferAction.parse_obj(obj)

        _obj = TonTransferAction.parse_obj({
