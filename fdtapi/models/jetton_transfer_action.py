...
class JettonTransferAction(BaseModel):
    ...
    senders_wallet: StrictStr = Field(...)
    recipients_wallet: StrictStr = Field(...)
    amount: StrictStr = Field(..., description="amount in quanta of tokens")
    comment: Optional[StrictStr] = None
    encrypted_comment: Optional[EncryptedComment] = None
    refund: Optional[Refund] = None
    jetton: JettonPreview = Field(...)
    __properties = ["sender", "recipient", "senders_wallet", "recipients_wallet", "amount", "comment", "encrypted_comment", "refund", "jetton"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JettonTransferAction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JettonTransferAction:
        """Create an instance of JettonTransferAction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JettonTransferAction.parse_obj(obj)

        _obj = JettonTransferAction.parse_obj({
            ...
            "senders_wallet": obj.get("senders_wallet"),
            "recipients_wallet": obj.get("recipients_wallet"),
